...
// Not working code due to replace method in loop;
// /**
//  * @param {number} n
//  * @return {string[][]}
//  */
...
//     if (validate([...arr], i, x)) {
//       let tempArr = [...arr];
//       let rowString = tempArr[i];
//       tempArr[i] = rowString.replace(rowString.substring(x, x + 1), "Q");

//       nQueenMethod(i + 1, n, tempArr, out);
//     }
//   }
